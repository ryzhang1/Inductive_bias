...
class Critic(nn.Module):
    def __init__(self, OBS_DIM, ACTION_DIM, TARGET_DIM, RNN_SIZE, FC_SIZE, RNN):
        ...
        # Q1 architecture
        self.rnn1 = RNN(input_size=OBS_DIM + ACTION_DIM + TARGET_DIM + ACTION_DIM, hidden_size=220)
        self.l1 = nn.Linear(220, 1)
        
        # Q2 architecture
        self.rnn2 = RNN(input_size=OBS_DIM + ACTION_DIM + TARGET_DIM + ACTION_DIM, hidden_size=220)
        self.l2 = nn.Linear(220, 1)
